  ...
  de: {
    translation: {
      ...
      team: {
        ...
        formWin: "Sieg (3)",
        formDraw: "Remis (1)",
        formLoss: "Niederlage (0)",
        formResult: "Spiel",
        formCaption:
          "Je Balken ein Länderspiel (neueste rechts). Höhe = geholte Punkte, Farbe = Ausgang. Antippen zeigt Gegner und Ergebnis.",
  ...
  en: {
    translation: {
      ...
      team: {
        ...
        formResult: "Match",
        formCaption:
          "Each bar is one international (newest on the right). Height = points won, colour = result. Tap to see opponent and score.",
        form: "Form",
        formPoints: "Points",
